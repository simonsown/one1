    ...
    <>
      <nav 
        className={`fixed top-0 left-0 right-0 z-50 w-full border-b border-[#1e293b] transition-all duration-300 ${
          isScrolled 
            ? 'bg-[#0b1121]/90 backdrop-blur-md py-2 shadow-lg' 
            : 'bg-[#0b1121] py-4'
        }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-row items-center justify-between">
            ...
            <Link href="/" className="flex flex-row items-center gap-2 flex-shrink-0 group">
              ...
              <span className="font-bold text-white tracking-tight hidden sm:block">PC MASTER <span className="text-[#f97316]">LMS</span></span>
            </Link>
                ...
                return (
                  <Link 
                    ...
                    className={`relative px-4 py-2 rounded-full flex flex-row items-center gap-2 text-sm font-medium transition-colors ${
                      isActive ? 'text-white' : 'text-slate-400 hover:text-white hover:bg-[#1e293b]'
                    }`}
                  >
                    {isActive && (
                      <motion.div 
                        layoutId="navbar-indicator"
                        className="absolute inset-0 bg-[#1e293b] rounded-full -z-10 border border-[#334155]"
            ...
            <div className="flex flex-row items-center gap-2 sm:gap-4">
              ...
              <div className="hidden md:block relative">
                {loading ? (
                  ...
                  <>
                    ...
                    >
                      <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-[#f97316] to-[#ea580c] p-[2px]">
                      ...
                      {avatarDropdownOpen && (
                        <>
                          ...
                          <motion.div 
                            ...
                            className="absolute right-0 mt-2 w-56 bg-[#0f172a] border border-[#1e293b] rounded-xl shadow-2xl py-2 z-50"
                          >
                            <div className="px-4 py-2 border-b border-[#1e293b] mb-2">
                              ...
                              <div className="mt-1 inline-block px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-[#f97316]/10 text-[#f97316] border border-[#f97316]/20">
                                {role}
                              </div>
                            </div>
                  ...
                  <Link href="/login" className="px-4 py-2 bg-[#f97316] text-white text-sm font-bold rounded-lg hover:bg-[#ea580c] transition-colors shadow-[0_2px_8px_rgba(249,115,22,0.3)]">
                    Đăng nhập
                  </Link>
                )}
              </div>
              ...
              <button 
                className="md:hidden p-2 text-slate-400 hover:text-white bg-[#1e293b] rounded-lg border border-[#334155]"
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div 
              ...
              className="fixed top-0 left-0 bottom-0 w-[280px] bg-[#0b1121] border-r border-[#1e293b] z-[70] flex flex-col md:hidden shadow-2xl"
            >
              {/* Drawer Header */}
              <div className="p-4 border-b border-[#1e293b] flex items-center justify-between bg-[#0f172a]/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {userProfile && (
                      <div className="text-xs text-[#f97316] uppercase font-bold">{role}</div>
                    )}
                  </div>
                </div>
                ...
                {userProfile && (
                  <>
                    ...
                    <Link 
                      href="/profile"
                      onClick={() => setMobileMenuOpen(false)}
                      className="flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-slate-300 hover:bg-[#1e293b] hover:text-white transition-colors"
                    >
              ...
              {/* Drawer Footer */}
              <div className="p-4 border-t border-[#1e293b] bg-[#0f172a]/30">
                {userProfile ? (
                  <button 
                  ...
                  <Link 
                    href="/login"
                    onClick={() => setMobileMenuOpen(false)}
                    className="w-full flex items-center justify-center py-3 rounded-xl font-bold bg-[#f97316] text-white hover:bg-[#ea580c] transition-colors shadow-[0_2px_12px_rgba(249,115,22,0.3)]"
                  >
                    Đăng nhập / Đăng ký
                  </Link>
                )}
