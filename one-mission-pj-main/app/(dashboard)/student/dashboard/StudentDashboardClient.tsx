              ...
              <motion.div className="lms-card" style={{ padding: '24px', background: 'var(--bg-surface)' }} whileHover={{ scale: 1.02, y: -2 }} transition={{ type: 'spring', stiffness: 300 }}>
                <div style={{ display: 'flex', gap: '16px', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap' }}>
                  <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                    <div style={{ width: '56px', height: '56px', borderRadius: '14px', background: 'linear-gradient(135deg, var(--warning), #d48a0a)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', flexShrink: 0 }}>
                      {dailyQuizCompleted ? '✅' : '📝'}
                    </div>
                    <div>
                  ...
                  {dailyQuizCompleted ? (
                    ...
                    <motion.div whileTap={{ scale: 0.98 }}>
                      <Link href={`/daily-quiz/${dailyQuiz.id}`} style={{ padding: '10px 24px', borderRadius: '99px', background: 'var(--accent-orange)', color: '#fff', fontWeight: 700, textDecoration: 'none', fontSize: '14px', flexShrink: 0, boxShadow: '0 2px 8px rgba(249,115,22,0.3)' }}>
                        Làm ngay →
                      </Link>
                    </motion.div>
                  )}
          ...
          <section style={{ display: 'grid', gap: '16px', gridTemplateColumns: '2fr 1.2fr' }}>
            <div className="lms-card" style={{ padding: '24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                ...
                <div style={{ padding: '4px 14px', borderRadius: '99px', border: '1px solid var(--brand-primary)', fontSize: '13px', fontWeight: 700, color: 'var(--brand-primary)', background: 'var(--brand-subtle)' }}>{percentageLabel}</div>
              </div>
