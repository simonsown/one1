  ...
  return (
    <div className="min-h-screen bg-[#161F38] text-[#dde0ed] p-4 sm:p-8 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-2xl w-full bg-[#11121d]/90 rounded-[28px] border border-gray-800 p-6 sm:p-8 text-center relative overflow-hidden shadow-2xl z-10">
        ...
        <p className="text-gray-400 mb-8 text-sm">Mã lần làm: {attemptId}</p>

        <div className="flex flex-col items-center justify-center mb-8">
          <div className={`w-36 h-36 rounded-full border-8 flex items-center justify-center mb-4 ${passed ? 'border-[#00d4aa] text-[#00d4aa] shadow-[0_0_20px_rgba(0,212,170,0.2)]' : 'border-red-500 text-red-500'}`}>
            <span className="text-5xl font-black">{score}</span>
          </div>
          <h2 className={`text-2xl font-black ${passed ? 'text-[#00d4aa]' : 'text-red-500'} uppercase tracking-widest`}>
        ...
        <div className="grid grid-cols-3 gap-4 mb-8 text-left">
          <div className="bg-black/25 p-4 rounded-2xl border border-white/5">
            ...
            <p className="text-lg sm:text-xl font-black text-[#00d4aa] mt-1">17/20</p>
          </div>
          <div className="bg-black/25 p-4 rounded-2xl border border-white/5">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          {passed ? (
            <button className="px-6 py-3 bg-[#00d4aa] text-[#0d0e13] rounded-2xl font-black hover:opacity-90 shadow-[0_0_15px_rgba(0,212,170,0.3)] text-sm transition-opacity">
              Nhận Chứng Chỉ
            </button>
          ) : (
            <button className="px-6 py-3 bg-[#00d4aa] text-[#0d0e13] rounded-2xl font-black hover:opacity-90 text-sm transition-opacity">
              Làm Lại
            </button>
          )}
        </div>
