...
export default function QuizResultsPage({ params }: { params: { attemptId: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[#f5f6f8] text-[#dde0ed] p-4 sm:p-8 flex flex-col items-center justify-center relative overflow-hidden">
      <div className="absolute inset-0 bg-grid-pattern opacity-[0.02] pointer-events-none" />
      
      <div className="max-w-2xl w-full bg-[#ffffff]/90 rounded-[28px] border border-gray-200 p-6 sm:p-8 text-center relative overflow-hidden shadow-2xl z-10">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8 text-left">
          <div className="bg-black/25 p-4 rounded-2xl border border-gray-200">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/student" className="px-6 py-3 border border-gray-300 hover:border-gray-500 rounded-2xl hover:bg-gray-100/40 transition-all font-bold text-sm text-slate-300 hover:text-white">
            Về Dashboard
          </Link>
          {passed ? (
