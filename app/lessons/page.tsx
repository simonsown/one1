...
export default async function LessonsListPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] text-white p-6 md:p-12 lg:p-20">
      <header className="max-w-7xl mx-auto mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tight">
              Khám phá <span className="text-[#089e60]">Kiến thức</span>
            </h1>
          </div>
        ...
        <div className="flex items-center gap-4 bg-[#ffffff] p-4 rounded-2xl border border-[#e7e7e7]">
          <div className="w-12 h-12 rounded-xl bg-[#089e60]/20 text-[#089e60] flex items-center justify-center">
             <Layers size={24} />
          </div>
          <div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {lessons?.map((lesson) => {
          ...
          return (
            <Link 
              ...
              className="group relative bg-[#ffffff] rounded-3xl border border-[#e7e7e7] overflow-hidden hover:border-[#089e60] transition-all hover:shadow-[0_0_30px_rgba(0,210,160,0.1)] flex flex-col h-full"
            >
              {/* Cover Image Placeholder or Real Image */}
              <div className="aspect-video w-full bg-[#f8f9fa] relative overflow-hidden">
                <img 
                ...
                {isCompleted && (
                  <div className="absolute top-4 right-4 bg-[#089e60] text-black p-2 rounded-full shadow-lg">
                    <CheckCircle size={20} />
                  </div>
                )}
              ...
              <div className="p-8 flex flex-col flex-1">
                <h3 className="text-2xl font-bold mb-3 group-hover:text-[#089e60] transition-colors leading-tight">
                  {lesson.title}
                </h3>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-[#e7e7e7]">
                  <div className="flex items-center gap-2 text-[#089e60] font-bold text-sm">
        ...
        {(!lessons || lessons.length === 0) && (
           <div className="col-span-full py-20 text-center border-2 border-dashed border-[#e7e7e7] rounded-3xl">
