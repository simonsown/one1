    ...
    <div className="min-h-screen bg-[#f8f9fa] text-white">
      ...
      <main className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="bg-[#ffffff] rounded-2xl border border-[#e7e7e7] overflow-hidden mb-8 shadow-xl">
          {/* Banner */}
          <div className="h-48 md:h-64 bg-gradient-to-r from-[#089e60]/20 via-[#289cf9]/20 to-purple-500/20 relative group">
          ...
          <div className="px-6 md:px-10 pb-8 relative">
            <div className="flex flex-col md:flex-row md:items-end gap-6 md:gap-8 -mt-16 md:-mt-20 relative z-10">
              ...
              <div className="relative group self-start">
                ...
                <button className="absolute bottom-2 right-2 p-2.5 bg-[#089e60] text-black rounded-full hover:bg-[#0b755b] shadow-lg transition-transform hover:scale-110">
                  <Camera size={18} />
                </button>
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="text-slate-400 mt-1 flex items-center gap-2">
                      ...
                      <span className="uppercase text-xs font-bold text-[#289cf9] bg-[#289cf9]/10 px-2 py-0.5 rounded border border-[#289cf9]/20">
                        {profile.role}
                      </span>
                    </p>
                  </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-[#ffffff] p-5 rounded-2xl border border-[#e7e7e7] flex items-center gap-4 hover:border-[#e7e7e7] transition-colors">
            <div className="w-12 h-12 rounded-xl bg-[#089e60]/10 text-[#089e60] flex items-center justify-center shrink-0">
              <BookOpen size={24} />
            </div>
            <div>
          ...
          <div className="bg-[#ffffff] p-5 rounded-2xl border border-[#e7e7e7] flex items-center gap-4 hover:border-[#e7e7e7] transition-colors">
            <div className="w-12 h-12 rounded-xl bg-[#289cf9]/10 text-[#289cf9] flex items-center justify-center shrink-0">
              <Award size={24} />
            </div>
            <div>
        ...
        <div className="bg-[#ffffff] rounded-2xl border border-[#e7e7e7] overflow-hidden min-h-[500px]">
          
          {/* Tabs */}
          <div className="flex overflow-x-auto border-b border-[#e7e7e7] scrollbar-hide">
            {tabs.map((tab) => (
              <button
                key={tab.id}
              ...
              >
                ...
                {activeTab === tab.id && (
                  <motion.div 
                    ...
                    className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#089e60]"
                  />
                )}
              </button>
            ))}
            ...
            <AnimatePresence mode="wait">
              {activeTab === 'activity' && (
                <motion.div key="activity" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
                  ...
                  <div className="relative border-l border-[#e7e7e7] ml-4 space-y-8 pb-4">
                    {/* Activity Item */}
                    ...
                    <div className="relative pl-8">
                      <div className="absolute w-4 h-4 bg-yellow-500 rounded-full left-[-8.5px] top-1 border-4 border-[#ffffff]"></div>
                  ...
                  <button className="mt-4 flex items-center gap-1 text-sm font-medium text-[#289cf9] hover:text-[#089e60] transition-colors pl-4">
                ...
                <motion.div key="exams" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="border-b border-[#e7e7e7] text-sm text-slate-400">
                      ...
                      <tbody>
                        <tr className="border-b border-[#e7e7e7] hover:bg-[#e7e7e7]/30 transition-colors">
                          ...
                          <td className="py-4 px-4 font-bold text-[#089e60]">9.5</td>
                          ...
                          <td className="py-4 px-4 text-right"><button className="text-sm font-medium text-[#289cf9] hover:underline">Xem chi tiết</button></td>
                        </tr>
                        <tr className="border-b border-[#e7e7e7] hover:bg-[#e7e7e7]/30 transition-colors">
