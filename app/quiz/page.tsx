    ...
    <div className="min-h-screen bg-[#f8f9fa] text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
        <header className="mb-12">
          <h1 className="text-4xl font-black mb-4">Thử thách <span className="text-[#089e60]">Nhanh</span></h1>
          <p className="text-slate-400">Kiểm tra kiến thức tức thì với các bài trắc nghiệm ngắn từ bài giảng.</p>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          <div className="p-6 bg-gradient-to-br from-[#089e60]/20 to-[#289cf9]/20 border border-[#089e60]/30 rounded-3xl">
             <Zap size={32} className="text-[#089e60] mb-4" />
             <h3 className="font-bold">Động lực học</h3>
             <p className="text-xs text-slate-500 mt-1">Trả lời đúng nhận x2 XP</p>
          </div>
          <div className="p-6 bg-[#ffffff] border border-[#e7e7e7] rounded-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {quizzes.map((quiz) => (
              <motion.div 
                ...
                className="bg-[#ffffff] border border-[#e7e7e7] rounded-3xl p-6 hover:shadow-[0_0_30px_rgba(0,210,160,0.1)] transition-all group"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-[#e7e7e7] text-[#089e60] rounded-xl flex items-center justify-center">
                    <HelpCircle size={20} />
                  </div>
                ...
                <Link 
                  href={`/quiz/${quiz.id}`}
                  className="w-full py-4 bg-[#f8f9fa] text-white border border-[#e7e7e7] group-hover:border-[#089e60] group-hover:text-[#089e60] font-bold rounded-2xl flex items-center justify-center gap-2 transition-all"
                >
