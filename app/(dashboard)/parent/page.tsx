...
export default function ParentDashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#f5f6f8] text-gray-900 flex justify-center items-center">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-gray-200">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="p-2.5 bg-white border border-gray-200 rounded-xl hover:bg-gray-100 transition-colors text-gray-400 hover:text-gray-900"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Child Profile Box */}
            <div className="relative bg-[#ffffff]/90 border border-gray-200 rounded-3xl p-6 shadow-xl overflow-hidden group">
              ...
              <div className="flex items-center gap-4 pb-4 border-b border-gray-200">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 tracking-tight">{child.full_name}</h4>
              ...
              <div className="pt-4 space-y-3 text-xs">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="bg-white px-2 py-0.5 rounded text-[#089e60] font-bold border border-[#089e60]/10">Lớp {child.grade}</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="bg-[#ffffff]/90 border border-gray-200 rounded-3xl p-6 shadow-xl space-y-4">
              ...
              <div className="space-y-4 max-h-[300px] overflow-y-auto pr-1">
                {announcements.map(ann => (
                  <div key={ann.id} className="bg-black/30 border border-gray-200 p-4 rounded-2xl hover:border-[#089e60]/20 transition-colors space-y-2">
                    ...
                    <h4 className="font-bold text-xs text-gray-900 leading-snug">{ann.title}</h4>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-[#ffffff]/90 border border-gray-200 rounded-3xl p-6 shadow-xl relative overflow-hidden">
                ...
                {activities.map(act => (
                  <div key={act.id} className="relative group">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-3">
                        <h4 className="text-xs font-bold text-gray-900 group-hover:text-[#089e60] transition-colors">{act.title}</h4>
            ...
            {/* Quiz Results Panel */}
            <div className="bg-[#ffffff]/90 border border-gray-200 rounded-3xl p-6 shadow-xl">
              ...
              <div className="space-y-4">
                {quizzes.map(q => (
                  <div key={q.id} className="bg-black/25 border border-gray-200 p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="space-y-1">
                      <h4 className="text-xs font-bold text-gray-900">{q.quiz_title}</h4>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {/* Bar indicator */}
                      <div className="w-24 bg-white h-2 rounded-full overflow-hidden hidden sm:block">
                        <div 
