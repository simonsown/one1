  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center p-6 text-white">
      <motion.div 
        ...
        className="w-full max-w-md bg-[#ffffff] border border-[#e7e7e7] p-8 md:p-10 rounded-3xl shadow-2xl text-center"
      >
        ...
        <div className="mb-6 inline-flex p-4 bg-[#089e60]/10 text-[#089e60] rounded-2xl">
          <QrCode size={32} />
        </div>
        ...
        <div className="relative inline-block p-6 bg-white rounded-3xl mb-8">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="w-12 h-12 bg-[#f8f9fa] rounded-xl flex items-center justify-center border-4 border-white">
        ...
        <div className="grid grid-cols-2 gap-4 text-left">
          <div className="p-4 bg-[#f8f9fa] rounded-2xl border border-[#e7e7e7]">
            <Smartphone size={20} className="text-[#089e60] mb-2" />
          ...
          <div className="p-4 bg-[#f8f9fa] rounded-2xl border border-[#e7e7e7]">
            <Monitor size={20} className="text-[#089e60] mb-2" />
        ...
        <div className="mt-8 pt-6 border-t border-[#e7e7e7]">
          <p className="text-xs text-slate-500">
            Gặp khó khăn? <Link href="/login" className="text-[#089e60] hover:underline">Thử cách đăng nhập khác</Link>
          </p>
        </div>
      </motion.div>
    </div>
